                    ...
                    <div className="grid gap-20">
                        ...
                        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                            ...
                            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={'https://po-prod.s3.us-west-1.amazonaws.com/features/feat-1.png'} width={540} height={405} alt="Features 01" />
                            </div>
                            {/* Content */}
                        ...
                        <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
                            {/* Image */}
                            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-5 lg:col-span-6 mb-8 md:mb-0 md:order-1" data-aos="fade-up">
                                <Image className="max-w-full mx-auto md:max-w-none h-auto" src={'https://po-prod.s3.us-west-1.amazonaws.com/features/constructive-design.png'} width={540} height={405} alt="Features 03" />
                            </div>
                            {/* Content */}
                            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                                <div className="md:pr-4 lg:pr-12 xl:pr-16">
